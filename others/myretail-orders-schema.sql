...
CREATE TABLE IF NOT EXISTS `order_product` (
  ...
  CONSTRAINT `order_product_ibfk_1` FOREIGN KEY (`order`) REFERENCES `orders` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `order_track` (
  ...
  CONSTRAINT `order_track_ibfk_1` FOREIGN KEY (`status`) REFERENCES `order_status_codes` (`id`),
  CONSTRAINT `order_track_ibfk_2` FOREIGN KEY (`order`) REFERENCES `orders` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- Data exporting was unselected.

-- Dumping structure for table myretail_orders.product_units
...
-- Dumping structure for table myretail_orders.product_unit_map
